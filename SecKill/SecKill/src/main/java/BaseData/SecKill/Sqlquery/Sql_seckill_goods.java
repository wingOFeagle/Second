		...
		TimerTask task = new TimerTask()
		{
			...
			public void run()
			{
				...
				try
				{
					...
					String sql = String.format("select sku_id,sku_name,jd_price,promo_price,start_date,end_date from cms_seckill_goods where status=1 and start_time <= '%s' and end_time >= '%s';",time_now,time_now);
